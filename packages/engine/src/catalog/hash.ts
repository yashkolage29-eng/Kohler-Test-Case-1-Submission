// Pure-TS SHA-256 (FIPS 180-4) — deterministic, dependency-free. The engine may not
// import node:crypto or any Node/DOM ambient API (engine purity), so the hash of the
// canonical catalog form is computed here.
...
/** SHA-256 of the UTF-8 encoding of `message`, lowercase hex. */
